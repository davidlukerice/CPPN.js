...
(function() {
	 ...
	 * @param depth [0,1] 
	 **/
	CPPN.Node = function(type, activationIndex, depth) {
		this.type = type;
		this.id = this.getNextId();
		this.deepId = this.getNextDeepId();

		if (typeof activationIndex === 'undefined' || activationIndex === null)
	...
	CPPN.Node.prototype = {
		 ...
		 **/
		copy: function() {
			var copy = new CPPN.Node(this.type, this.activationFunctionIndex, this.depth);
			copy.id = this.id;
			return copy;
		},
